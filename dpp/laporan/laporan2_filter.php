            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="../laporan2.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                    <p>Dari tanggal <?=tgl_indo($tgl1)?> s/d <?=tgl_indo($tgl2)?></p>
                    <a href="preview_ft2.php?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2?>" class="btn btn-dark" target="_blank"><i class="fa fa-eye"></i> Preview</a>
                    <a class="btn btn-success" href="cetak2_excel_filter.php?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2?>" target="_blank"><i class="fa fa-file-excel"></i> Excel</a>
                    <a class="btn btn-danger" href="cetak2_pdf_filter.php?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2?>" target="_blank"><i class="fa fa-file-pdf"></i> PDF</a>
                    ...
                    <div class="table-responsive mt-2" style="color:black;">
                        <table id="example" class="display" style="width:100%; background-color: white; color: black;">
                            ...
                            <?php
                                ...
                                inner join stasi on dana_mandiri.id_stasi=stasi.id_stasi where tgl_pembayaran between  '$tgl1' and '$tgl2' order by tgl_pembayaran asc ");
