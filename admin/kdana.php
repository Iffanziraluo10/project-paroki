            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-0">Data Dana Mandiri</h1>
                    </div>
                    ...
                    <div class="table-responsive mt-2" style="color:black;">
                        <table id="example" class="display" style="width:100%; background-color: white; color: black;">
                            ...
                            <?php
                                ...
                                inner join stasi on lingkungan.id_stasi=stasi.id_stasi order by id_dana asc");		
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="dana_mandiri/edit_dana.php?id=<?php echo $d['id_dana'];?>">Edit<i></i></a>
                                        <a class="btn btn-danger" href="dana_mandiri/hapus_dana.php?id=<?php echo $d['id_dana'];?>">Hapus<i></i></a>
                                    </td>
                                </tr>
                                    <?php
                                }
