            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-0">Data Lingkungan</h1>
                    </div>
                    <a href="lingkungan/tambah_lingkungan.php" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                    <!-- <a href="lingkungan/preview.php" class="btn btn-primary" target="_blank"><i class="fa fa-eye"></i> Preview</a>
                    <a href="lingkungan/print_lingkungan.php" class="btn btn-success"><i class="fa fa-print"></i> Cetak</a> -->
                        ...
                        <table id="example" class="display" style="width:100%; background-color: white; color: black;">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="lingkungan/edit_lingkungan.php?id=<?php echo $d['id_lingkungan'];?>">Edit<i></i></a>
                                        <a class="btn btn-danger" href="lingkungan/hapus_lingkungan.php?id=<?php echo $d['id_lingkungan'];?>">Hapus<i></i></a>
                                    </td>
                                </tr>
                                    <?php
                                }
