            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-0">Data Stasi / Wilayah</h1>
                    </div>
                    <a href="stasi/tambah_stasi.php" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                    <!-- <a href="" class="btn btn-success"><i class="fa fa-print"></i> Print</a> -->
                    <div class="table-responsive mt-2" style="color:black;">
                        <table id="table-data" class="display" style="width:100%; background-color: white; color: black;">
                            <thead>
                                <tr>
                                    <th>No</th>
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $data = mysqli_query($koneksi,"SELECT * from stasi order by   id_stasi asc");		
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="stasi/edit_stasi.php?id=<?php echo $d['id_stasi'];?>">Edit<i></i></a>
                                        <a class="btn btn-danger" href="stasi/hapus_stasi.php?id=<?php echo $d['id_stasi'];?>">Hapus<i></i></a>
                                    </td>
                                </tr>
                                    <?php
                                }
