        ...
        <div class="sidebar pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="edit_pastor.php" class="nav-item nav-link active"><i class="fa fa-users me-2"></i>Data Pastor</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-0">Data Pastor</h1>
                    </div>
                    <!-- <a href="dana_mandiri/tambah_dana.php" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a> -->
                    <div class="table-responsive mt-2" style="color:black;">
                        <table id="example" class="display" style="width:100%; background-color: white; color: black;">
                            ...
                            <?php
                                $no = 1;
                                $data = mysqli_query($koneksi,"SELECT * FROM pastor order by id_pastor asc");		
                                while($d=mysqli_fetch_array($data)){
                                    ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $d['nama_pastor'] ?></td>
                                    <td><img src="../img/<?php echo $d['foto'] ?>" width="70px" alt=""> </td>
                                    <td><?php echo $d['keterangan'] ?></td>
                                    <td>
                                        <a class="btn btn-warning" href="data_pastor/edit_pastor.php?id=<?php echo $d['id_pastor'];?>">Edit<i></i></a>
                                    </td>
                                </tr>
                                    <?php
                                }
