...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href=".././stasi.php" class="dropdown-item active"><i class="fa fa-place-of-worship"></i>  Data Stasi</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Edit Data Stasi</h6>
                        <a href="../stasi.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                    <?php
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi,"SELECT * from stasi where id_stasi='$id'");
					while($d = mysqli_fetch_array($data)){
                    ?>
                    <form action="" method="POST" name="Form" onsubmit="return validateForm()">
                        <div class="mb-3">
                        <input class="form-control" type="hidden" name="id" value="<?php echo $d['id_stasi']; ?>">
                            <label for="" class="form-label">Nama Stasi / Wilayah</label>
                            <input type="text" class="form-control" value="<?php echo $d['nama_stasi'] ?>" name="namastasi">
                        </div>
            ...
            if(isset($_POST['Edit'])){
                $id_stasi = $_POST['id'];
                $namastasi = $_POST['namastasi'];

                $query_edit = mysqli_query($koneksi, "UPDATE stasi SET nama_stasi='$namastasi' where id_stasi='$id_stasi'");
    ...
    <script>
        function validateForm() {
            var a = document.forms["Form"]["namastasi"].value;
