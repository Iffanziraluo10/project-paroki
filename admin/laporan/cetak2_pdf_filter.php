<?php
    ...
    $nama_file = ('Laporan_Dana_Masuk_Dana_Mandiri_per_tgl '.tgl_indo ($tgl1).' _s/d_ '.tgl_indo ($tgl2).' ');
    ob_start();
...
?>    
    ...
    <head>
        ...
        <title>Cetak PDF Filter 2</title>
    ...
    <table class="table2" style="border-style: none;">
        ...
        <hr>
        <h4>
            Laporan Dana Masuk untuk Pembayaran Dana Mandiri dari<br> Tanggal <?=tgl_indo($tgl1) ?> 
            s/d <?= tgl_indo($tgl2)?>
        </h4>
            ...
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid;">Tahun</th>
            ...
            <?php
                ...
                inner join stasi on umat.id_stasi=stasi.id_stasi where tgl_pembayaran between  '$tgl1' and '$tgl2' order by tgl_pembayaran asc ");
                ...
                <tr>
                    ...
                    <td style="border: 1px solid; text-align: center;"><?= $d["bulan"] ?></td>
                    <td style="border: 1px solid; text-align: center;"><?=$d["tahun"] ?></td>
