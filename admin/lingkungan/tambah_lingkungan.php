    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Tambah Data Lingkungan</h6>
                    ...
                    <form action="" method="POST" name="Form" onsubmit="return validateForm()">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="namalin">
                        </div>
                        <div class="mb-3">
            ...
            if(isset($_POST['tambah'])){
                ...
                $query_tambah = mysqli_query($koneksi, "INSERT INTO lingkungan VALUES ('','".$namalin."','".$stasi."')");
