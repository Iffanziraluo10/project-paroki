...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Tambah Data Umat</h6>
                    ...
                    <form action="" method="POST" name="Form" onsubmit="return validateForm()">
                        <div class="mb-3">
                            <label for="" class="form-label">Nomor Kepala Keluarga</label>
            ...
            if(isset($_POST['tambah'])){
                ...
                $query_tambah = mysqli_query($koneksi, "INSERT INTO umat VALUES ('','".$nokk."','".$namakk."','".$lingkungan."','".$stasi."')");
    ...
    <!-- <script>
        ...
        var inputText = document.getElementById("stasi");
