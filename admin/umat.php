        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <a href="umat/tambah_umat.php" class="btn btn-danger"><i class="fa fa-plus"></i> Tambah</a>
                            ...
                            <tbody>
                                ...
                                while($d=mysqli_fetch_array($data)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="umat/edit_umat.php?id=<?php echo $d['id_umat'];?>">Edit<i></i></a>
                                            <a class="btn btn-danger" href="umat/hapus_umat.php?id=<?php echo $d['id_umat'];?>">Hapus<i></i></a>
                                        </td>
                                    <?php
                                }
                                ?>
