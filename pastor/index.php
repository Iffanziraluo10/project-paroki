    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Pastor</span>
                        </a>
                ...
                <div class="row g-4">
                    <div class="col">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-user-friends fa-3x coklat"></i>
                            <div class="ms-3">
                                <p class="mb-2">Jumlah Umat</p>
                                <?php $umat=mysqli_query($koneksi,"SELECT * from umat"); ?>
                                <h6 class="mb-0"><?php echo mysqli_num_rows($umat) . " umat"; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-place-of-worship fa-3x coklat"></i>
                            <div class="ms-3">
                                <p class="mb-2">Jumlah Stasi</p>
                                <?php $stasi=mysqli_query($koneksi,"SELECT * from stasi"); ?>
                                <h6 class="mb-0"><?php echo mysqli_num_rows($stasi) ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-home fa-3x coklat"></i>
                            <div class="ms-3">
                                <p class="mb-2">Jumlah Lingkungan</p>
                                <?php $lingkungan=mysqli_query($koneksi,"SELECT * from lingkungan"); ?>
                                <h6 class="mb-0"><?php echo mysqli_num_rows($lingkungan) ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <h4 class="mt-5 pb-5">Selamat Datang <span class="text-danger text-uppercase"><?php echo $_SESSION['username'] ?></span> <i class="fa fa-smile"></i> <br> 
                        Sistem Informasi Pengelolaan Dana Mandiri (SIPDM) <br>
                        <i class="fa fa-cross"></i> Gereja Katolik Paroki St. Fransiskus Assisi Padang Bulan Medan
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid pt-4 px-4 fixed-bottom" >
                ...
                <!-- Back to Top -->
                <a href="#" style="position: absolute;" class="btn btn-lg bg_coklat btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
            </div>
            <!-- Footer End -->
        </div>
        <!-- Content End -->
