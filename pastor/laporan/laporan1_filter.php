        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <a href="preview_ft1.php?stasi=<?= $stasi ?>&bulan=<?= $triwulan?>&tahun=<?= $tahun ?>" class="btn btn-dark" target="_blank"><i class="fa fa-eye"></i> Preview</a>
                    <a class="btn btn-success" href="cetak1_excel_filter.php?stasi=<?= $stasi; ?>&bulan=<?= $triwulan?>&tahun=<?= $tahun ?>" target="_blank"><i class="fa fa-file-excel"></i> Excel</a>
                    <a class="btn btn-danger" href="cetak1_pdf_filter.php?stasi=<?= $stasi; ?>&bulan=<?= $triwulan?>&tahun=<?= $tahun ?>" target="_blank"><i class="fa fa-file-pdf"></i> PDF</a>

                    <div class="table-responsive mt-2" style="color:black;">
                    <h5 style="color:red;"><?php echo $stasi?></h5>
