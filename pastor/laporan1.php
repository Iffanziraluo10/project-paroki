...
<body>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <h5>Filter Berdasarkan Stasi</h5>
                        </div>
                        <div class="col-3">
                            <!-- Stasi -->
                            <select class="form-select" name="stasi">
                                <option value="">--Stasi--</option>
                                <?php
                                $query = "SELECT * FROM stasi";
                                $data = mysqli_query($koneksi,$query);
                                while($d=mysqli_fetch_array($data)){
                                    echo "<option>".$d['nama_stasi']."</option>";
                                }
                                ?>
                            </select>
                        </div>
    ...
    <script>
        function validateForm() {
            var a = document.forms["Form"]["stasi"].value;
