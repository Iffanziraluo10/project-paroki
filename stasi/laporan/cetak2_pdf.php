...
<!DOCTYPE html>
    ...
    <table class="table2" style="border-style: none;">
        ...
        <hr>
        <h4>
            Laporan Dana Masuk untuk Pembayaran Dana Mandiri pada <br> <?=$stasi?><br>
        </h4>
        <table class="table1" cellpadding="5" cellspacing ="0">
            ...
            <?php
                ...
                inner join stasi on dana_mandiri.id_stasi=stasi.id_stasi where nama_stasi='$stasi' order by id_dana asc");
