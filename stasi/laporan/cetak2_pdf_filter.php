<?php
    ...
    $nama_file = ('Laporan_Dana_Masuk_Dana_Mandiri_per_tgl '.tgl_indo ($tgl1).' _s/d_ '.tgl_indo ($tgl2).' pada '.$stasi.' ');
    ob_start();
...
?>    
    ...
    <head>
        ...
        <title>Cetak PDF Filter 2 <?=$stasi?></title>
    ...
    <table class="table2" style="border-style: none;">
        ...
        <hr>
        <h4>
            Laporan Dana Masuk untuk Pembayaran Dana Mandiri dari<br> Tanggal <?=tgl_indo($tgl1) ?> s/d <?= tgl_indo($tgl2)?> pada <br> <?=$stasi?>
        </h4>
