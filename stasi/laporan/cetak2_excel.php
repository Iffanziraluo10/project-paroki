<?php
    ...
    header("Content-Disposition: attachment; filename=laporan_dana_masuk_keseluruhan('$stasi').xls");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container-fluid">
    ...
    <h4>
        Laporan Dana Masuk untuk Pembayaran Dana Mandiri pada <?=$stasi?><br>
    </h4>
    <table style="width:100%; background-color: white; color: black;">
        ...
        <?php
            ...
            inner join stasi on dana_mandiri.id_stasi=stasi.id_stasi where nama_stasi = '$stasi' order by tgl_pembayaran asc");		
