                    ...
                    <div class="col">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <?php $umat=mysqli_query($koneksi,"SELECT * from umat inner join stasi on umat.id_stasi=stasi.id_stasi where nama_stasi='$stasi'"); ?>
                    ...
                    <div class="col">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <?php $lingkungan=mysqli_query($koneksi,"SELECT * from lingkungan inner join stasi on lingkungan.id_stasi=stasi.id_stasi where nama_stasi = '$stasi' "); ?>
                                <h6 class="mb-0"><?php echo mysqli_num_rows($lingkungan) ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <h4 class="mt-5 pb-5">Selamat Datang <span class="text-danger text-uppercase"><?php echo $stasi ?></span> <i class="fa fa-smile"></i> <br> 
