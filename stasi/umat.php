                    ...
                    <div class="table-responsive mt-2" style="color:black;">
                        <table id="table-data" class="stripe" style="width:100%; background-color: white; color: black;">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $data = mysqli_query($koneksi,"SELECT * from umat inner join lingkungan on umat.id_lingkungan=lingkungan.id_lingkungan inner join stasi on umat.id_stasi=stasi.id_stasi where nama_stasi='$stasi' order by id_umat asc ");		
