...
<head>
    <meta charset="utf-8">
    <title>Data Lingkungan | <?= $stasi ?></title>
                ...
                <div class="bg-light rounded p-4">
                    ...
                    <div class="table-responsive mt-2" style="color:black;">
                        <table id="example" class="display" style="width:100%; background-color: white; color: black;">
                            ...
                            <?php
                                $no = 1;
                                $data = mysqli_query($koneksi,"SELECT * from lingkungan inner join stasi on lingkungan.id_stasi = stasi.id_stasi where nama_stasi = '$stasi' ");		
